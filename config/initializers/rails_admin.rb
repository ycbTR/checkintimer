# RailsAdmin config file. Generated on November 28, 2013 16:10
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Checkintimer', 'Admin']
  ...
  #     configure :oauth_secret, :string
  #     configure :user_id, :integer         # Hidden
  #     configure :provider, :string
  #     configure :profile_picture_url, :string
